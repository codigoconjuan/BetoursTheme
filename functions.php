...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('large', 1100, 540, true); // Large Thumbnail
    add_image_size('medium', 500, 270, true);
    add_image_size('small', 200, 175, true);
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('bxsliderjs', get_template_directory_uri() . '/js/jquery.bxslider.min.js', array(), '4.0.1'); // Modernizr
...
function html5blank_styles()
{
    ...
    wp_register_style('1140', get_template_directory_uri() . '/css/1140.css', array(), '1.0', 'all');
    ...
    wp_register_style('font', 'http://fonts.googleapis.com/css?family=Oswald:400,700,300', array(), '1.0', 'all');
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'redes-menu' => __('Redes Sociales Menu', 'html5blank'), // Sidebar Navigation
    ));
}
