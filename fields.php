 ...
 * @return array
 */
function creativawebMetabox( array $meta_boxes ) {
	 ...
	 */
	$meta_boxes['html5-blank'] = array(
		'id'         => 'test_metabox',
		'title'      => __( 'Test Metabox', 'cmb' ),
		'pages'      => array( 'html5-blank', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
	 ...
	 */
	$meta_boxes['nosotros'] = array(
		'id'         => 'about_page_metabox',
		'title'      => __( 'Nosotros', 'cmb' ),
		'pages'      => array( 'page', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
		'show_on'    => array( 'key' => 'id', 'value' => array( 12, ), ), // Specific post IDs to display this metabox
		'fields'     => array(
			array(
				'name' => __( 'Imagen 1', 'cmb' ),
				'desc' => __( 'Una imagen.', 'cmb' ),
				'id'   => $prefix . 'imagen1',
				'type' => 'file',
			),
			array(
				'name' => __( 'Imagen 2', 'cmb' ),
				'desc' => __( 'Una imagen.', 'cmb' ),
				'id'   => $prefix . 'imagen2',
				'type' => 'file',
			),
...
add_filter( 'cmb_meta_boxes', 'creativawebMetabox' );
